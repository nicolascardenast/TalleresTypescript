...
exports.tv = exports.Serie = exports.TvSeries = void 0;
class TvSeries {
    constructor(series) {
        this.series = series;
    }
...
class Serie {
    constructor(position, name, channel, seasons, description, review, picture) {
...
let series = [new Serie(1, "Breaking Bad", "AMC", 5, "Set and filmed in Albuquerque, New Mexico, the series tells the story of Walter White, a struggling and depressed high school chemistry teacher who is diagnosed with lung cancer", "https://www.amc.com/shows/breaking-bad", "https://i.imgur.com/GGje0vc.jpg"),
...
exports.tv = new TvSeries(series);

let tablaSeries = document.getElementById("serie");
let tablaPromedios = document.getElementById("statistic");
desplegarDatosSeries(exports.tv.series);
desplegarPromedios(exports.tv.series);

function desplegarPromedios(series) {
    let tbodystatistic = document.createElement("tBody");
    let promedio = 0;
    ...
    tablaPromedios.appendChild(tbodystatistic);
}

function desplegarDatosSeries(series) {
